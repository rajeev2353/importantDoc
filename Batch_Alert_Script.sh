...
if [ "$?" -ne "0" ]
then
curl -w -F "http://sms.gngsms.com/api/sendhttp.php?user=manikaran&password=mplcontrol&mobiles=9910032957,9560389612&message=global_forecast_batch_STOPPED&sender=MNIKRN"
